...
class Arrows(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        self.btnleft = wx.ToggleButton(self.panel, leftID, 'upleft', (5,5))
        self.btnleft.Bind(wx.EVT_TOGGLEBUTTON, self.btnleftClick)

        self.btnleft = wx.ToggleButton(self.panel, leftID, 'left', (5,69))
        self.btnleft.Bind(wx.EVT_TOGGLEBUTTON, self.btnleftClick)

        self.btnleft = wx.ToggleButton(self.panel, leftID, 'downleft', (5,133))
        self.btnleft.Bind(wx.EVT_TOGGLEBUTTON, self.btnleftClick)

        self.btnleft = wx.ToggleButton(self.panel, leftID, 'up', (69,5))
        self.btnleft.Bind(wx.EVT_TOGGLEBUTTON, self.btnleftClick)

        self.btnleft = wx.ToggleButton(self.panel, leftID, 'centre', (69,69))
        self.btnleft.Bind(wx.EVT_TOGGLEBUTTON, self.btnleftClick)

        self.btnleft = wx.ToggleButton(self.panel, leftID, 'down', (69, 133))
        self.btnleft.Bind(wx.EVT_TOGGLEBUTTON, self.btnleftClick)

        self.btnleft = wx.ToggleButton(self.panel, leftID, 'upright', (133, 5))
        self.btnleft.Bind(wx.EVT_TOGGLEBUTTON, self.btnleftClick)

        self.btnleft = wx.ToggleButton(self.panel, leftID, 'right', (133, 69))
        self.btnleft.Bind(wx.EVT_TOGGLEBUTTON, self.btnleftClick)

        self.btnleft = wx.ToggleButton(self.panel, leftID, 'downright', (133, 133))
        self.btnleft.Bind(wx.EVT_TOGGLEBUTTON, self.btnleftClick)
